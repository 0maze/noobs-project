...
connection = pymysql.connect(host='sql7.freemysqlhosting.net',user='sql7618138',password='qg7yP6RzUk',db='sql7618138')
...
def run():
    ...
    # Create the DB
    db_sql = """CREATE DATABASE IF NOT EXISTS sql7618138;"""
    cursor.execute(db_sql)
    connection.select_db("sql7618138")
